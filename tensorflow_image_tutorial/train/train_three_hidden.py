...
from tensorflow_image_tutorial.operation import InputOp, InferenceOpWithThreeHidden, LossOp, TrainingOp, EvaluationOp
...
tf.app.flags.DEFINE_string('train_dir', '/tmp/not_mnist/not_mnist_train/three_hidden',
                           """Directory where to write event logs and checkpoint.""")
tf.app.flags.DEFINE_string('summaries_dir', '/tmp/not_mnist/not_mnist_logs/three_hidden', """Summaries directory""")
tf.app.flags.DEFINE_boolean('log_device_placement', False, """Whether to log device placement.""")
tf.app.flags.DEFINE_integer('max_steps', 5000, """Number of batches to run.""")
tf.app.flags.DEFINE_integer('batch_size', 128, """Number of images to process in a batch.""")
tf.app.flags.DEFINE_integer('learning_rate', 0.5, """Learning Rate.""")
...
def main():
    ...
    with tf.Graph().as_default():
        ...
        softmax, logits = InferenceOpWithThreeHidden(
            ...
            num_neurons_in_third_dense_layer=100
        ).add_ops(x)
