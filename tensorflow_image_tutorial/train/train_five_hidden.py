...
from tensorflow_image_tutorial.operation import InputOp, InferenceOpWithFiveHidden, LossOp, TrainingOp, EvaluationOp
...
tf.app.flags.DEFINE_string('summaries_dir', '/tmp/not_mnist/not_mnist_logs/five_hidden', """Summaries directory""")
...
def main():
    ...
    with tf.Graph().as_default():
        ...
        softmax, logits = InferenceOpWithFiveHidden(
