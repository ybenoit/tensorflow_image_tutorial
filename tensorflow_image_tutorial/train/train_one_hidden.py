...
from tensorflow_image_tutorial.operation import InputOp, InferenceOpWithOneHidden, LossOp, TrainingOp, EvaluationOp
...
tf.app.flags.DEFINE_string('train_dir', '/tmp/not_mnist/not_mnist_train/one_hidden',
                           """Directory where to write event logs and checkpoint.""")
tf.app.flags.DEFINE_string('summaries_dir', '/tmp/not_mnist/not_mnist_logs/one_hidden', """Summaries directory""")
