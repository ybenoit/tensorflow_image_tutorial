...
from tensorflow_image_tutorial.operation import InputOp, InferenceOp, LossOp, TrainingOp, EvaluationOp
...
tf.app.flags.DEFINE_string('train_dir', '/tmp/not_mnist/not_mnist_train/softmax',
                           """Directory where to write event logs and checkpoint.""")
tf.app.flags.DEFINE_string('summaries_dir', '/tmp/not_mnist/not_mnist_logs/softmax', """Summaries directory""")
