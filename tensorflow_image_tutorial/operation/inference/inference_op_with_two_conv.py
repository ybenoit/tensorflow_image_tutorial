...
class InferenceOpWithTwoConv:
    def __init__(self, num_pixels, num_classes, num_neurons_in_first_dense_hidden_layer,
                 num_channels_in_first_conv_layer, num_channels_in_second_conv_layer):
        self.num_pixels = num_pixels
        self.num_classes = num_classes
        self.num_neurons_in_first_dense_hidden_layer = num_neurons_in_first_dense_hidden_layer
        self.num_channels_in_first_conv_layer = num_channels_in_first_conv_layer
        self.num_channels_in_second_conv_layer = num_channels_in_second_conv_layer
    ...
    def add_ops(self, x):
        ...
        """
        conv_1 = self.add_conv_op(x=x,
                                  num_pixels_conv=5,
                                  num_channels_in_previous_layer=1,
                                  num_channels_in_current_layer=self.num_channels_in_first_conv_layer,
                                  name_scope="conv_1")

        pool_1 = self.add_max_pool_op(x=conv_1, name_scope="pool")

        conv_2 = self.add_conv_op(x=pool_1,
                                  num_pixels_conv=5,
                                  num_channels_in_previous_layer=self.num_channels_in_first_conv_layer,
                                  num_channels_in_current_layer=self.num_channels_in_second_conv_layer,
                                  name_scope="conv_2")
