...
class InferenceOpWithFiveHidden:
    def __init__(self, num_pixels, num_classes,
                 num_neurons_in_first_dense_layer=1024,
                 num_neurons_in_second_dense_layer=500,
                 num_neurons_in_third_dense_layer=250,
                 num_neurons_in_fourth_dense_layer=100,
                 num_neurons_in_fifth_dense_layer=50):
        ...
        self.num_neurons_in_fourth_dense_layer = num_neurons_in_fourth_dense_layer
        self.num_neurons_in_fifth_dense_layer = num_neurons_in_fifth_dense_layer
    ...
    def add_ops(self, x):
        ...
        dense_4 = self.add_dense_hidden_layer_op(dense_3,
                                                 self.num_neurons_in_third_dense_layer,
                                                 self.num_neurons_in_fourth_dense_layer,
                                                 name_scope="dense_4")

        dense_5 = self.add_dense_hidden_layer_op(dense_4,
                                                 self.num_neurons_in_fourth_dense_layer,
                                                 self.num_neurons_in_fifth_dense_layer,
                                                 name_scope="dense_5")

        softmax, logits = self.add_softmax_op(dense_5, self.num_neurons_in_fifth_dense_layer, self.num_classes,
                                              name_scope="softmax")
